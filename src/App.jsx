...
function App() {
  ...
  const IvyRecords = () => {
    setVideo("//https://www.youtube.com/watch?v=aLqc8TdoLJ0?autoplay=1&mute=1&start=10");
  ...
  const StudyMD = () => {
    setVideo("//www.youtube.com/embed/1WQCBJRVYcE?autoplay=1&mute=1&start=1");
  ...
  const NiceGuys = () => {
    setVideo("//www.youtube.com/embed/oVi5gtzTDx0?autoplay=1&mute=1&start=1");
